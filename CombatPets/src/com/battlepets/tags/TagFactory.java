...
import com.battlepets.placeholder.time.TimeFormater;
...
public class TagFactory{
	...
	public String playerParse(String parser) {
		...
		parser = parser.replace("%prefix%", BattlePets.getInstance().configManager.messages.prefix);
