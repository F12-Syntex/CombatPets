package com.battlepets.configs.gui;
...
import com.battlepets.GUI.GenerateItem;
import com.battlepets.GUI.PagedItem;
import com.battlepets.GUI.SpecialItem;
...
public class ConfigSection extends ConfigGUI {
	...
	public List<PagedItem> Contents() {
		...
		this.configSection.getKeys(false).forEach(i -> {
			...
			ItemStack section = new ItemStack(Material.valueOf(BattlePets.getInstance().configManager.configs.Sections));
			ItemStack ints = new ItemStack(Material.valueOf(BattlePets.getInstance().configManager.configs.Numbers));
			ItemStack text = new ItemStack(Material.valueOf(BattlePets.getInstance().configManager.configs.Text));
			ItemStack booleanON = new ItemStack(Material.valueOf(BattlePets.getInstance().configManager.configs.BooleanON));
			ItemStack booleanOFF = new ItemStack(Material.valueOf(BattlePets.getInstance().configManager.configs.BooleanOFF));
			ItemStack lists = new ItemStack(Material.valueOf(BattlePets.getInstance().configManager.configs.Lists));
					...
					execution = () -> {
						...
						Communication.applyInput(player, new Input() {
							...
							public void onRecieve(String o) {
								...
								Bukkit.getScheduler().callSyncMethod(BattlePets.getInstance(), new Callable<Object>() {
									@Override
